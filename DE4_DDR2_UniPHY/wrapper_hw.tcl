...
add_fileset_file rbm_demo.v VERILOG PATH ip/wrapper/rbm_demo.v TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL rbm_demo
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file rbm_demo.v VERILOG PATH ip/wrapper/rbm_demo.v
...
add_interface_port s0 avs_s0_readdata readdata Output ADDRESS_WIDTH
add_interface_port s0 avs_s0_readdatavalid readdatavalid Output 1
add_interface_port s0 avs_s0_writedata writedata Input ADDRESS_WIDTH
...
add_interface_port user coe_user_data_available export Input 1
add_interface_port user coe_user_read_buffer export Output 1
add_interface_port user coe_user_buffer_data export Input DATAWIDTH
...
add_interface_port control coe_control_fixed_location export Output 1
add_interface_port control coe_control_read_base export Output ADDRESS_WIDTH
add_interface_port control coe_control_read_length export Output ADDRESS_WIDTH
add_interface_port control coe_control_go export Output 1
add_interface_port control coe_control_done export Input 1
add_interface_port control coe_control_early_done export Input 1
