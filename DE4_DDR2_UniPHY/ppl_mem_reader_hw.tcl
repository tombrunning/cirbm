...
# Tue Jun 30 16:23:56 BST 2015
# DO NOT MODIFY


# 
# ppl_mem_reader "Pipelined memory read template" v1.0
#  2015.06.30.16:23:56
# 
# 
...
# 
# module ppl_mem_reader
# 
set_module_property DESCRIPTION ""
set_module_property NAME ppl_mem_reader
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME "Pipelined memory read template"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL latency_aware_read_master
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file latency_aware_read_master.v VERILOG PATH ip/Master_Template/latency_aware_read_master.v TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL latency_aware_read_master
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file latency_aware_read_master.v VERILOG PATH ip/Master_Template/latency_aware_read_master.v
...
add_interface_port control coe_control_fixed_location export Input 1
add_interface_port control coe_control_read_base export Input ADDRESSWIDTH
add_interface_port control coe_control_read_length export Input ADDRESSWIDTH
add_interface_port control coe_control_go export Input 1
add_interface_port control coe_control_done export Output 1
add_interface_port control coe_control_early_done export Output 1
...
set_interface_property user associatedClock clock
set_interface_property user associatedReset reset
set_interface_property user ENABLED true
set_interface_property user EXPORT_OF ""
set_interface_property user PORT_NAME_MAP ""
set_interface_property user SVD_ADDRESS_GROUP ""

add_interface_port user coe_user_read_buffer export Input 1
add_interface_port user coe_user_data_available export Output 1
add_interface_port user coe_user_buffer_data export Output DATAWIDTH
