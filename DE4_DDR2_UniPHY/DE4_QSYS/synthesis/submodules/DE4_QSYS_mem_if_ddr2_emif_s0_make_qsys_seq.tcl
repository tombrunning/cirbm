set arg_list [list]
lappend arg_list "--component-param=PROTOCOL=DDR2"
...
lappend arg_list "--component-param=MAX_LATENCY_COUNT_WIDTH=6"
...
lappend arg_list "--component-param=MEM_T_WL=4"
...
lappend arg_list "--component-param=SEQUENCER_VERSION=11.1"
...
catch { eval [concat [list exec "C:/altera/11.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
