...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux_007.sv"                                        -work rsp_xbar_demux_007                                                             
  ...
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux_004.sv"                                        -work rsp_xbar_demux_004                                                             
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux.sv"                                            -work rsp_xbar_demux                                                                 
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                           -work cmd_xbar_mux_004                                                               
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_mux_004.sv"                                          -work cmd_xbar_mux_004                                                               
  ...
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_demux_003.sv"                                        -work cmd_xbar_demux_003                                                             
  ...
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_id_router_007.sv"                                             -work id_router_007                                                                  
  ...
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_id_router_004.sv"                                             -work id_router_004                                                                  
  ...
  vlogan +v2k -sverilog                                      "$QSYS_SIMDIR/submodules/DE4_QSYS_addr_router_003.sv"                                           -work addr_router_003                                                                
  ...
  vlogan +v2k                                                "$QSYS_SIMDIR/submodules/latency_aware_read_master.v"                                           -work ppl_mem_reader                                                                 
  vlogan +v2k                                                "$QSYS_SIMDIR/submodules/rbm_demo.v"                                                            -work wrapper                                                                        
