...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux_006.sv \
  ...
  $QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux_005.sv \
  $QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_mux_005.sv \
  $QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_demux_004.sv \
  ...
  $QSYS_SIMDIR/submodules/DE4_QSYS_id_router_006.sv \
  ...
  $QSYS_SIMDIR/submodules/DE4_QSYS_addr_router_004.sv \
