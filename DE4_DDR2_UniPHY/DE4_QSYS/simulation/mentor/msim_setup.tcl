...
alias com {
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux_007.sv"                                        -work rsp_xbar_demux_007                                                             
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_rsp_xbar_demux_004.sv"                                        -work rsp_xbar_demux_004                                                             
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_mux_004.sv"                                          -work cmd_xbar_mux_004                                                               
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_cmd_xbar_demux_003.sv"                                        -work cmd_xbar_demux_003                                                             
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_id_router_007.sv"                                             -work id_router_007                                                                  
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_id_router_004.sv"                                             -work id_router_004                                                                  
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/DE4_QSYS_addr_router_003.sv"                                           -work addr_router_003                                                                
  ...
  vlog                                        "$QSYS_SIMDIR/submodules/latency_aware_read_master.v"                                           -work ppl_mem_reader                                                                 
  vlog                                        "$QSYS_SIMDIR/submodules/rbm_demo.v"                                                            -work wrapper                                                                        
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L a0 -L ng0 -L dll0 -L oct0 -L c0 -L s0 -L m0 -L p0 -L pll0 -L irq_synchronizer -L irq_mapper -L crosser -L width_adapter -L rsp_xbar_mux_005 -L rsp_xbar_demux_007 -L cmd_xbar_demux_005 -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_004 -L rsp_xbar_demux -L cmd_xbar_mux_004 -L cmd_xbar_mux -L cmd_xbar_demux_003 -L cmd_xbar_demux_002 -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_007 -L addr_router_005 -L id_router_005 -L id_router_004 -L id_router_002 -L id_router -L addr_router_003 -L addr_router_002 -L addr_router_001 -L addr_router -L nios2_qsys_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_jtag_debug_module_translator -L nios2_qsys_instruction_master_translator -L ppl_mem_reader -L wrapper -L dma -L ddr2_i2c_sda -L ddr2_i2c_scl -L mm_clock_crossing_bridge_io -L button -L led -L timer -L sysid -L jtag_uart -L nios2_qsys -L mem_if_ddr2_emif -L onchip_memory -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixiv_hssi_ver -L stratixiv_pcie_hip_ver -L stratixiv_ver $TOP_LEVEL_NAME
}
