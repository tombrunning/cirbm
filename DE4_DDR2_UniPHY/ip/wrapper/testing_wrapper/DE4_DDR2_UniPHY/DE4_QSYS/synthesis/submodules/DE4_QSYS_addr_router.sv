...
(
    ...
    localparam PAD2 = log2ceil(64'h41041020 - 64'h41041010); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h41041020;
    ...
    // ( 0x41041010 .. 0x41041020 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 31'h41041010   ) begin
            src_channel = 6'b100;
