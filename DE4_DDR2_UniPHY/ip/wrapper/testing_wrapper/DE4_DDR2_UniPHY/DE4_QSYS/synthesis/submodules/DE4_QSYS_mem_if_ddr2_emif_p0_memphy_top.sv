...
module DE4_QSYS_mem_if_ddr2_emif_p0_memphy_top(
	global_reset_n,
	soft_reset_n,
	reset_request_n,
	ctl_reset_n,
...
assign afi_rlat = 0;
	...
	DE4_QSYS_mem_if_ddr2_emif_p0_memphy	umemphy(
		...
		defparam umemphy.TB_MEM_CLK_FREQ   = "400.0";
...
`else
	DE4_QSYS_mem_if_ddr2_emif_p0_sim_delay #(.delay(1)) sim_delay_inst(.o(delayed_pll_locked_pre), .i(pll_locked));
`endif
...
begin
	...
	DE4_QSYS_mem_if_ddr2_emif_p0_pll_memphy	upll_memphy(
...
begin
	...
	DE4_QSYS_mem_if_ddr2_emif_p0_dll_memphy  udll_memphy(
...
endgenerate
	...
	DE4_QSYS_mem_if_ddr2_emif_p0_oct_control	uoct_control(
