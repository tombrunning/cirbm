...
module rbm_demo (
    ...
    input avs_s0_read;
    input avs_s0_write;
    input [3:0] avs_s0_address;// 0001 -> write base address; 0010 -> write transfer length
...
//Avalon slave signal configuration
    always @(posedge clk or posedge reset) begin
        if(reset == 1) begin
            ...
            if (avs_s0_write == 1 & avs_s0_address == 'b0001) begin
                base_address <= avs_s0_writedata;
                base_address_ready <= 1'b1;
            end 
            if (avs_s0_write == 1 & avs_s0_address == 'b0010) begin
